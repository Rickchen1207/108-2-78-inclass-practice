...
```{r}
weather_next36hours$cwbopendata$dataset$location$weatherElement -> a
map(a,~.x$time[[1]]$startTime)
map(a,~.x$time[[1]]$endTime)
map(a,~.x$time[[1]]$parameter$parameterValue)
```
